...
export const LoadingFX: React.FC<LoadingFXProps> = ({ uiLanguage = 'en' }) => {
    ...
    return (
        <div className="w-full h-full bg-white overflow-hidden relative border-r-4 border-gray-300">
            ...
            <p className="absolute bottom-24 inset-x-0 text-center font-comic text-xl text-gray-400 animate-pulse z-0 tracking-widest">{S.inking}</p>
        </div>
    );
};
